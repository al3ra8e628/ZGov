...
<title>مساكن الأسر العفيفة   </title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="212" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">مساكن الأسر العفيفة   </p>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c1" > الطلبات المقدمة من المواطنين </label> </td> <td> <input type="file" accept="image/*" name="RECQUSTS_CITIZENS" id="recqusts_citizens"  disabled ></tr>
<tr><td width="210pt"> <label> <input type="checkbox" id="c5" > دفتر عائلة المعيل</label> </td> <td> <input type="file" accept="image/*" name="FAMILY_BOOK" id="family_book"  disabled ></tr>
<tr><td width="210pt"> <label> <input type="checkbox" id="c6" > شهادة اثبات وجود اعاقة</label> </td> <td> <input type="file" accept="image/*" name="CERTIFICATE_PROOF" id="certificate_proof"  disabled ></tr>
<table/>
<br><br>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c3" > وزارة الداخلية </label> </td> <td> <input type="file" accept="image/*" name="MINISTRY" id="ministry" disabled ></td></tr>
<tr><td width="210pt"> <label> <input type="checkbox" id="c4" > مديرية التنمية الإجتماعية</label> </td> <td> <input type="file" accept="image/*" name="DIRECTIRATE" id="directirate" disabled="disabled"/></td></tr>
</table>
...
enable("c1","recqusts_citizens");
enable2("c2","section","s1");
enable2("c3","ministry");
enable2("c4","directirate");
enable2("c5","family_book");
enable2("c6","certificate_proof");
