...
<title>ترخيص محلات صياغة الحلي وبيع المجوهرات</title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="103" />
		


<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">ترخيص محلات صياغة الحلي وبيع المجوهرات</p>
...
<a href="/ZGov/GovSystem?HU$CMD=OPEN_FILE&DIS=ADD_PROCESS"><input class="form-appointment" type="button" value="انـهـاء" ></input></a></div><br><br><br>		
</form>
