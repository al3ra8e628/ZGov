...
<input type="hidden" name="HU$PROCESS_NUM" value="213" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">طلب المساعدة   </p>
...
enable("c3","ministry");
enable("c4","directirate");
enable("c5","family_book");
enable("c6","certificate_proof");
