...
<title>الموافقة على تعيين لجنة زكاة مسجد </title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="130" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">الموافقة على تعيين لجنة زكاة مسجد</p>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c2"> موافقة على تعيين لجنة زكاه </label> </td> <td> <input type="file" accept="image/*" name="ZAKAT_SITE" id="Zakat_site" disabled ></tr>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c4" > تعليمات الزكاة وتعديلاتها</label> </td> <td><input type="file" accept="image/*" name="INSTRUCTION" id="instruction" disabled ></tr>
...
<select style="max-width:75px; min-width:75px" style="max-width:200px;" name = "INTELLIGENCE_DEPARTMENTS" disabled id ="s6">
		<%
...
<select style="max-width:75px; min-width:75px" name = "ENDOWMENTS_DEPARTMENTS" disabled id ="s7">
		<%
		...
		%>
		</select></td></tr></table> </td> <td> <input type="file" accept="image/*" name="ENDOWMENTS" id="endowmnts" disabled></tr>
</table><br><br><br>
