...
<title>تعيين هيئة اختيارية جديدة </title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="125" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">تعيين هيئة اختيارية جديدة</p>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c2"> كتاب تعين هيئه اختيارية جديدة</label> </td> <td> <input type="file" accept="image/*" name="DESIGNATION_SITE" id="Designation_site" disabled ></tr>
<tr><td width="210pt"> <label> <input type="checkbox" id="c3" > نموذج خاص بتواقيع ابناء العشيرة </label> </td> <td><input type="file" accept="image/*" name="SIGNATURES" id="Signatures" disabled ></tr>
<tr><td width="210pt"> <label> <input type="checkbox" id="c4" > صورة عن الهويات الشخصية </label> </td> <td><input type="file" accept="image/*" name="IDENTIFICATION" id="identification" disabled ></tr>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c7" > وزارة الداخلية </label> </td> <td> <input type="file" accept="image/*" name="MINISTRY" id="ministry" disabled ></td></tr>
</table><br><br><br>
<table>
<tr><td colspan="2" style="font-size:20pt; font-weight:bold"> المواطنين:</td> </tr>
<tr><td width="210pt"><label><input type="checkbox" id="c8">  ابناء الحي او العشيرة</label></td> <td> <input type="file"  accept="image/*" name="CLAN" id="clan" disabled></tr>
</table><br><br><br>
...
enable("c1","call_up");
enable("c2","Designation_site");
enable("c3","Signatures");
enable("c4","identification");


enable2("c5","s5","police");
enable2("c42","s12","unit");

enable2("c6","s6","intelligence");
