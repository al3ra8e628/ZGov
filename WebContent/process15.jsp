...
<input type="hidden" name="HU$PROCESS_NUM" value="115" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">ترخيص صالون سيدات</p>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c9" > وزارة الداخلية </label> </td> <td> <input type="file" accept="image/*" name="MINISTERY" id="ministery" disabled ></td></tr>
