...
<title>ترخيص الحمام التركي </title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="108" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">ترخيص الحمام التركي</p>
