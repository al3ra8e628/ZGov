...
<body dir="rtl" >
	...
	<div class="form">
		<form method="post" action="GovSystem" 
			...
			<input type="hidden" name="HU$PROCESS_NUM" value="101" />

			<p
				style="text-align: center; margin-top: -1px; font-size: 30pt; font-weight: bold;">ترخيص
				صالات افراح</p>
			...
			<hr style="margin-left: 6%; margin-right: 6%; margin-top: -3%">
				...
				<div style="padding-let: 3%; padding-right: 3%">
					...
					<label style="font-size: 18pt; font-weight: bold;">
						...
						style="height: 25px; border-radius: 5pt;" minlength="10" maxlength="10" required />
						 ...
						 <br><br>
								<table>
									...
									<tr>
										<td width="210pt"><label> <input type="checkbox"
												id="c2"> مخطط موقع تنظيمي </label></td>
										<td><input type="file" accept="image/*" name="MAP_SITE"
											id="map_site" disabled>
									</tr>
									<tr>
										<td width="210pt"><label> <input type="checkbox"
												id="c3"> رخصة انشاءات </label></td>
										<td><input type="file" accept="image/*" name="LICENSE"
											id="license" disabled>
									</tr>
								</table>
								<br> <br><br>
						...
						id="unit" disabled>
												...
												<tr>
													<td width="210pt">
														<table>
															<tr>
																<td width="100pt"><label><input
																		type="checkbox" id="c5"> البلدية </label></td>
																<td><select
																	style="max-width: 75px; min-width: 75px"
												...
												<tr>
													<td width="210pt">
														<table>
															<tr>
																<td width="100pt"><label><input
																		type="checkbox" id="c6"> الدفاع المدني </label></td>
																<td><select
																	style="max-width: 75px; min-width: 75px"
												...
												<tr>
													<td width="210pt">
														<table>
															<tr>
																<td width="100pt"><label><input
																		type="checkbox" id="c7"> الصحة </label></td>
																<td><select
																	style="max-width: 75px; min-width: 75px"
											...
											<br><br><br>
														...
														<table>
															<tr>
																<td colspan="2"
																	style="font-size: 20pt; font-weight: bold">سند
																	الكفالة العدلية :</td>
															</tr>
															<tr>
																<td width="210pt"><label><input
																		type="checkbox" id="c8"> سند الكفالة
																	</label></td>
														...
														<br><br><br>
																	...
																	<table>
																		...
																		<tr>
																			<td width="210pt"><label> <input
																					type="checkbox" id="c10"> البلدية صاحبة
																						الاختصاص </label></td>
																			<td><input type="file" accept="image/*"
																				name="CITY_HALL2" id="city_hall2" disabled></td>
																		</tr>
																	</table>
																	<br><br><br><br><br>
...
<input class="form-appointment" type="button" onclick="addProcess()" value="حـفـظ"/>
