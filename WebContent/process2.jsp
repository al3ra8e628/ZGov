...
<title>ترخيص محلات المشروبات الروحية</title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="102" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">ترخيص محلات المشروبات الروحية</p>
...
<label style="font-size:20pt;font-weight:bold;"> الرقم الوطني :</label>
	 <input type="text" name="PERSON_ID" size="40"
						style="height: 25px; border-radius: 5pt;" required minlength="10" maxlength="10"/><br><br><br><br>
<table>
