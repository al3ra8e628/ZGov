...
<title>صفحة اضافة مركز صحي</title>
...
<body dir="rtl">
	...
	<%@include file="/template_header.jsp"%>
			...
			<div class="center form well">
				...
				<h4 class="text-info form-caption"> اضافة مركز صحي </h4>
				<hr class="line" />
				...
				<form action="/ZGov/GovSystem" method="post">
					...
					<table class="center" id="form">
						...
						<tr>
							<td><label>رقم المركز الصحي :</label></td>
							<td><input type="text" name="h_dept_id" oninput="clearResult()" maxlength="10"
								required /></td>
						</tr>

						<tr>
							<td><label>اسم المركز الصحي :</label></td>
							<td><input type="text" name="h_dept_name"  maxlength="80"
								 required></td>
						</tr>
	...
	<a href="/ZGov/GovSystem?HU$CMD=OPEN_FILE&DIS=HOME_ADMIN"><input type="button" id="btn-back" value="رجوع"/></a>
				<br>
					...
					<input type="hidden" name="HU$CMD" value="ADD_HEALTH_DEPARTMENT">
				</form>
