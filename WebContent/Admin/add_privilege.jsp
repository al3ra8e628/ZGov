...
<body dir="rtl">
	...
	<div class="center form well">
		...
		<h4 class="text-info form-caption">منح صلاحيات لموظف</h4>
		<hr class="line" />
		...
		<form action="/ZGov/GovSystem" method="post" id="form">
			...
			<table class="center">
				...
				<tr>
					...
					<td><input type='text'  maxlength='10'
						...
						src='/ZGov/photos/check.png' id="check_icon" onclick='getUser(1)' />
					</td>
				</tr>
				...
				if (user_id != null) {
					for (int department_id : departments) {
						...
						String query = "select process_num , process_name from process where department_id ="
								+ department_id
								+ "  and process_num not in (select process_num from user_department_process where "
								+ " 	user_id =" + user_id + ")";
			...
			<input type="hidden" name="HU$CMD" value="ADD_PRIVILEGE">
		</form>
		<%
