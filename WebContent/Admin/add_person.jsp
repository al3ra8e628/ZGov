				...
				<form action="/ZGov/GovSystem" method="post" id="form">
					...
					<table class="center">
						...
						<tr>
							...
							<td><input type="text" name="first_name" maxlength="80"   required /></td>
							<td><label style="margin-right: 15px;">اسم الاب :</label></td>
							<td><input type="text" name="mid_name" maxlength="80" /></td>
						</tr>
						<tr>
							<td><label>اسم العائلة :</label></td>
							<td><input type="text"   name="last_name" maxlength="80" required /></td>
						</tr>
						<tr>
