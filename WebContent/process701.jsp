...
<title>شكاوى عامة ضمن اختصاص الحاكم الاداري</title>
...
<body dir="rtl">
	...
	<div class="form" style="background-color: #BDE4A7;">
		<form method="post" action="GovSystem" enctype="multipart/form-data" id="form">
			...
			<input type="hidden" name="HU$CMD" value="SAVE_DOCUMENT" /> <input
				type="hidden" name="HU$PROCESS_NUM" value="701" />
			...
			شكاوى عامة ضمن اختصاص الحاكم الاداري	</p>
