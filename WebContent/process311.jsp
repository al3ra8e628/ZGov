...
<title>نقل ملكية محطة المحروقات</title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="311" />


<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">نقل ملكية محطة المحروقات</p>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c1" > كتاب رسمي (وزارة الطاقة والثرةو المعدنية)</label> </td> <td> <input type="file" accept="image/*" name="CALL_UP" id="call_up"  disabled ></tr>
