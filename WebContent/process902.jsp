...
<title>منح إجازة سنوية للموظفين في الوحدات الإدارية التنفيذية لمركز المحافظة</title>
</head>
	...
	<div class="form" style="background-color: #FFCDB2;">
		<form method="post" action="GovSystem" enctype="multipart/form-data" id="form">
			...
			<input type="hidden" name="HU$CMD" value="SAVE_DOCUMENT" /> <input
				type="hidden" name="HU$PROCESS_NUM" value="902" />

			<p style="text-align: center; margin-top: -1px; font-size: 30pt; font-weight: bold;">منح إجازة سنوية للموظفين في الوحدات الإدارية التنفيذية لمركز المحافظة<p>
...
<table>
				...
				<table>
					<tr>
						<td colspan="2" style="font-size: 20pt; font-weight: bold">الشركاء :</td>
					</tr>
				...
				<table>
					...
					<tr>
						<td width="210pt"><label><input type="checkbox"
								id="c2"> وزارة الداخلية </label></td>
						<td><input type="file" accept="image/*" name="PATRNER" id="vac2"
							disabled>
					</tr>
				</table>
				<br>
