...
<title>منح إجازة سنوية للموظفين في مركز المحافظة</title>
</head>
	...
	<div class="form" style="background-color: #FFCDB2;">
		<form method="post" action="GovSystem" enctype="multipart/form-data" id="form">
			...
			<input type="hidden" name="HU$CMD" value="SAVE_DOCUMENT" /> <input
				type="hidden" name="HU$PROCESS_NUM" value="901" />

			<p style="text-align: center; margin-top: -1px; font-size: 30pt; font-weight: bold;">منح إجازة سنوية للموظفين في مركز المحافظة<p>
