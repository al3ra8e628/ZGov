...
<title>ترخيص المقاهي الشعبية</title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="106" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">ترخيص المقاهي الشعبية</p>
