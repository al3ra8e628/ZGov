...
<title>الكتب الواردة او الشكاوي بسبب وقوع انهيارات او وجود مباني ايلة للسقوط</title>
</head>
<body>   
<body dir="rtl">
...
<div class="form"  style="background: #EF9A9A">
		<form method="post" action="GovSystem" enctype="multipart/form-data">
			...
			<input type="hidden" name="HU$CMD" value="SAVE_DOCUMENT" /> <input
				type="hidden" name="HU$PROCESS_NUM" value="308" />

			<p
				style="text-align: center; margin-top: -1px; font-size: 30pt; font-weight: bold;">الكتب الواردة او الشكاوي بسبب وقوع انهيارات او وجود مباني ايلة للسقوط</p>
