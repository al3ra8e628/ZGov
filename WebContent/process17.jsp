...
<input type="hidden" name="HU$PROCESS_NUM" value="117" />
		


<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">رفع قرارات الحجز</p>
...
<select style="max-width:75px; min-width:75px" name = "MINISTRY_OF_INTERNAL_AFFAIRS" disabled id ="s1">
	...
	String	sql = "SELECT * FROM gov.MINISTRY_OF_INTERNAL_AFFAIRS";
...
<select style="max-width:75px; min-width:75px" style="max-width:200px;" name = "CUSTOMS_DEPARTMENT" disabled id ="s2">
		...
		%></select> </td></tr></table> </td><td> <input type="file" accept="image/*" name="CUSTOMS" id="customs" disabled ></tr>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c11" >االجهات المعنية لتنفيذ قرار رفع الحجز </label> </td> <td> <input type="file" accept="image/*" name="RESPONSABLE" id="responsable" disabled ></td></tr>
