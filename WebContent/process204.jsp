...
<title>اعداد التقارير الشهرية والسنوية وتقرير تثدم سير العمل</title>
</head>
...
<input type="hidden" name="HU$PROCESS_NUM" value="204" />
		

<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">اعداد التقارير الشهرية والسنوية وتقرير تثدم سير العمل</p>
...
<tr><td width="210pt"> <label> <input type="checkbox" id="c1" > التقارير التي يتم تزويد وحدة تنمية بها من كافة القطاعات </label> </td> <td> <input type="file" accept="image/*" name="REPORT_PIC" id="report_pic"  disabled ></tr>
</table><br>
<br><br>

<table>
<tr><td  colspan="2" style="font-size:20pt; font-weight:bold">الشركاء الداخليين (اللجان) :</td> </tr>
<tr><td > <table> <tr> <td width="100pt"> <label><input type="checkbox" id="c2" > الدائرة مالكة المشروع </label>  </td> <td> 
...
<tr><td > <table> <tr> <td width="100pt"> <label><input type="checkbox" id="c3" > اللجنة الفنية </label>  </td> <td> 
<select style="max-width:75px; min-width:75px" name = "COMMITTEET_DEPARTMENT" disabled id ="s3">
		<%
		 conn = DatabaseConnection.getConnection() ; 
		 sql = "SELECT * FROM gov.COMMITTEET_DEPARTMENTS";
		...
		%></select></td></tr></table> </td> <td> <input type="file" accept="image/*" name="COMMITTEET" id="committeet" disabled></tr>
