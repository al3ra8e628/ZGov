...
<input type="hidden" name="HU$PROCESS_NUM" value="105" />
		


<p style="text-align:center; margin-top:-1px; font-size:30pt; font-weight:bold;">ترخيص الكرات الملونة</p>
...
<tr><td colspan="2" style="font-size:20pt; font-weight:bold"><br> مجلس الأعلى للشباب :</td> </tr>
<tr><td width="210pt"><label><input type="checkbox" name="c55" id="c888">  مجلس الأعلى للشباب  </label></td> <td> <input type="file"  accept="image/*" name="YOTHMINISTRY" id="yothministry" disabled></tr>
</table><br><br><br>
